...
export default function Home() {
  ...
  return (
    <div className='w-screen min-h-screen h-full bg-slate-950'>
      ...
      <div className='w-full min-h-[500px] flex flex-col items-center justify-start pt-[100px] px-4 md:px-0'>
        <div className='flex flex-col items-center justify-start text-center'>
          <span className='text-3xl md:text-5xl font-bold text-slate-100'>The best <span className='bg-gradient-to-r from-sky-300 to-indigo-400 text-transparent bg-clip-text'>Sui</span> Development Suite</span>
        ...
        <div className={
          'w-full md:w-[1000px] min-h-[600px] mt-[75px] shadow-[0_0_75px_-10px_rgb(0,0,0,0.3)] hover:shadow-[0_0_100px_-25px_rgb(0,0,0,0.3)] transition-shadow rounded-xl bg-transparent border overflow-hidden' +
          ...
          <div className="w-full flex flex-row items-start justify-around border-b text-xs md:text-lg">
            <div
              className={
          ...
          {
            activeTab === 'editor' &&
            <div className='h-[500px] flex flex-col md:flex-row items-center justify-around p-8 md:p-2'>
              <div className='w-full md:w-fit h-[450px] flex flex-col items-start justify-start ps-4'>
      ...
      <div className='mt-[100px] w-full h-fit flex flex-col items-center justify-start gap-10'>
        <span className='mt-10 text-4xl font-bold text-slate-100 text-center'>Built for <span className='bg-gradient-to-r from-teal-300 to-emerald-500 text-transparent bg-clip-text'>Efficiency</span></span>
        <div className='w-full md:w-[600px] h-[100px] border rounded-xl flex flex-row bg-gradient-to-b from-slate-950 to-emerald-500/20 shadow-[0_0_40px_-10px_rgb(0,0,0,0.3)] shadow-emerald-500/50'>
          <div className='w-full md:w-[200px] flex flex-col items-center justify-center'>
            <span className='text-xs font-bold flex flex-row items-center gap-2'><PackagePlus strokeWidth={1.25} className='h-5 w-5' />1000+</span>
            <span className='text-xs text-slate-400'>Deployed packages</span>
          </div>
          <Separator orientation='vertical' className='h-[100px]' />
          <div className='w-full md:w-[200px] flex flex-col items-center justify-center'>
            <span className='text-xs font-bold flex flex-row items-center gap-2'><FileSearch2 strokeWidth={1.25} className='h-5 w-5' />700+</span>
            <span className='text-xs text-slate-400'>Objects views</span>
          </div>
          <Separator orientation='vertical' className='h-[100px]' />
          <div className='w-full md:w-[200px] flex flex-col items-center justify-center'>
            <span className='text-xs font-bold flex flex-row items-center gap-2'><Users strokeWidth={1.25} className='h-5 w-5' />500+</span>
      ...
      <div className='w-full mt-[100px] min-h-[500px] flex flex-col items-center justify-start'>
        <span className='mt-10 text-4xl font-bold text-slate-100 text-center'><span className='bg-gradient-to-r from-purple-300 to-indigo-500 text-transparent bg-clip-text'>Loved</span> by Developers</span>
        <div className='w-full md:w-fit grid grid-cols-1 md:grid-cols-3 mt-10 gap-4 px-4'>
          <div className='border rounded-xl w-full md:w-[300px] h-auto shadow-[0_0_40px_-10px_rgb(0,0,0,0.3)] shadow-indigo-500/50 p-4 text-slate-300'>
