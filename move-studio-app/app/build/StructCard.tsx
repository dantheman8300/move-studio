...
export default function StructCard(props: { data: any }) {
  return (
            ...
            return (
              <div key={index}>
                <span className="font-mono text-teal-800">
                  {parameter.isPhantom && "phantom"} T{index}
                </span>
                {parameter.constraints.abilities.length > 0 && (
                  <span className="text-slate-400"> has </span>
                )}
                {parameter.constraints.abilities.map(
                  (ability: string, index: number) => {
                    return (
                      <span key={index} className="text-teal-800 font-mono">
                        {`${ability}${
                          index < parameter.constraints.abilities.length - 1
                            ? ", "
                            : ""
                        }`}
                      </span>
              ...
              return (
                <div key={index}>
                  ...
                  <span className="font-mono text-teal-800 hover:text-teal-500">
                    {field.type.Struct.address}::{field.type.Struct.module}::
                        ...
                        <TooltipTrigger>
                          ...
                          {field.type.Vector.Struct != undefined
                            ? `${field.type.Vector.Struct.address}::${field.type.Vector.Struct.module}::${field.type.Vector.Struct.name}`
                                .length < 10
                              ? `${field.type.Vector.Struct.address}::${field.type.Vector.Struct.module}::${field.type.Vector.Struct.name}`
                              : `${field.type.Vector.Struct.address}::${field.type.Vector.Struct.module}::${field.type.Vector.Struct.name}`.slice(
                                  0,
                                  4
                                ) +
                                "..." +
                            ...
                            : `${field.type.Vector.slice(0, 4)}...${
                                field.type.Vector
                              }`.length < 10
                            ? `${field.type.Vector}`
                            : `${field.type.Vector.slice(
                                0,
                                4
                              )}...${field.type.Vector.slice(-4)}`}
                          {">"}
                        </TooltipTrigger>
                        <TooltipContent>
                          <p>
